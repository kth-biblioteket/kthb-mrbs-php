...
echo "<p>\n";
echo get_vocab("please_contact") . '<a href="https://www.kth.se/en/biblioteket/anvanda-biblioteket/oppettider-kontakt/kontaktformular-1.863120">KTH Biblioteket</a> ' . get_vocab("for_any_questions") . "\n";
echo "</p>\n";

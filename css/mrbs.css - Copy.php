...
#dwm_header li {padding-left: 0; margin-left: 0; margin-right: 10px;float:left}
...
td.K,.I.tentativeconfirmable {opacity: 1;backgrdound: linear-gradient(rgba(243, 179, 27, 0.85), rgba(222, 147, 18, 0.9)) !important; 1border: 1px solid #C9910A  !important;background-color: rgba(243, 179, 27, 0.85) !important} /*orange*/
...
.I.confirmed {opacity: 1;basckground: linear-gradient(rgba(249, 58, 58, 0.701961), rgba(230, 86, 86, 0.901961)) !important; 1border: 1px solid #A54637 !important;background-color: rgba(249, 58, 58, 0.701961)} /*röd*/
.I.tentative {1border: 1px solid #A3A537 !important;bacsdkground: linear-gradient(rgba(249, 243, 58, 0.701961), rgba(230, 226, 86, 0.901961)) !important;background-color: rgba(249, 243, 58, 0.701961)} /*gul*/
...
td.D.invalid {
    background: linear-gradient(rgba(249, 58, 58, 0.701961), rgba(230, 86, 86, 0.901961)) !important; /*röd*/
}
...
/* KTH färgkodning*/
table#colour_key {clear: both; float: left; border-spacing: 0; border-collapse: collapse; margin: 0.5em 0}
/* KTH */
#colour_key td {
	width: 7.0em; 
	padding: 2px;
...
.current {color: #000; background-color: #e3e5e3} 

...
var refreshPage = function refreshPage() {
    if (!isHidden() && !refreshPage.disabled)
    {
      ...
      <?php //KTH 
		//Om det ska fungera som inbäddad i polopoly måste hela URL:en vara med. http / https måste stämma överens med anropande sida.
	  ?>
      $.post(''+ refreshPage.args.page + '.php',
        ...
        function(result,status,xhr){
          ...
          {
            //191003 logga ut
            if(result.indexOf('ajaxlogout') !== -1 ) {
